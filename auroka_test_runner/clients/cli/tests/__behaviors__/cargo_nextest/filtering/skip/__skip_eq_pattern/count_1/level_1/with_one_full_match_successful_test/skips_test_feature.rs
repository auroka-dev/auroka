...
"#);
    when_auroka_test_runner_is_invoked_with_the_assembly_for_test_mode_and_the_arguments(test_mode, "--skip=level_1::pass");

    "Outputs no information about the skipped test" {
        then_the_standard_output_should_not_have("test assembly::level_1::pass");
    }
