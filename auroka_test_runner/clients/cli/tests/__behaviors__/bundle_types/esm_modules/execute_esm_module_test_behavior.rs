...
behavior! {
    ...
    given_there_is_an_esm_module_bundle_with(r#"
#[test]
fn test_one() {
    assert!(true);
}
...
"#);
    when_auroka_test_runner_is_invoked_with_the_assembly_for_test_mode_and_the_arguments(test_mode, "test_one --nocapture --exact");
    ...
    "Outputs the successful test 1 summary" {
        then_the_standard_output_should_have("test_one ... ok");
    }
    ...
    "Outputs no information about the test 2" {
        then_the_standard_output_should_not_have("test_two");
    }
