...
use crate::__steps__::auroka_test_runner::when_auroka_test_runner_is_invoked_with_the_assembly_for_test_mode;
...
mod level_1 {
    ...
    when_auroka_test_runner_is_invoked_with_the_assembly_for_test_mode(test_mode);

    "Outputs its running 1 tests" {
        then_the_standard_output_should_have("running 1 test");
    }

    "Outputs the successful test summary" {
        then_the_standard_output_should_have("test assembly::level_1::level_2::pass ... ok");
    }
